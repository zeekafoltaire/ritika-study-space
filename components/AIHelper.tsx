...
const UserIcon = () => <div className="w-8 h-8 rounded-full bg-gradient-to-br from-brand-accent to-brand-primary flex items-center justify-center font-bold text-white text-sm shrink-0">R</div>;


const AskDoubt: React.FC<{ onAddDoubt: (doubt: Omit<Doubt, 'id'>) => Promise<void> }> = ({ onAddDoubt }) => {
    const [messages, setMessages] = useState<ChatMessage[]>([
        { sender: 'ai', text: "Hello Ritika! Ask me any question about your studies, and I'll do my best to help you." }
    ]);
