...
const PeriodicTableIcon: React.FC<IconProps> = ({ className }) => (<svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h.5A2.5 2.5 0 0020 5.5V3.935m-14 0A2.5 2.5 0 018.5 2h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h.5a2.5 2.5 0 012.5 2.5m-14 0V11a2 2 0 002 2h2m0-10.5a2.5 2.5 0 00-2.5-2.5" /></svg>);
...
const navItems = [
    ...
    { id: Page.UnitConverter, icon: UnitConverterIcon },
    { id: Page.EquationBalancer, icon: EquationBalancerIcon },
];
